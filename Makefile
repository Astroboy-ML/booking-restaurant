...
tf-validate:
	AWS_PROFILE=$(AWS_PROFILE) AWS_REGION=$(AWS_REGION) AWS_DEFAULT_REGION=$(AWS_DEFAULT_REGION) $(TF) -chdir=$(TF_DIR) init $(if $(TF_BACKEND_BUCKET)$(TF_BACKEND_REGION)$(TF_BACKEND_DYNAMODB_TABLE),$(TF_INIT_BACKEND_OPTS),$(TF_BACKEND_CONFIG)) $(TF_INIT_FLAGS)
	AWS_PROFILE=$(AWS_PROFILE) AWS_REGION=$(AWS_REGION) AWS_DEFAULT_REGION=$(AWS_DEFAULT_REGION) $(TF) -chdir=$(TF_DIR) validate

tf-plan:
	AWS_PROFILE=$(AWS_PROFILE) AWS_REGION=$(AWS_REGION) AWS_DEFAULT_REGION=$(AWS_DEFAULT_REGION) $(TF) -chdir=$(TF_DIR) init $(if $(TF_BACKEND_BUCKET)$(TF_BACKEND_REGION)$(TF_BACKEND_DYNAMODB_TABLE),$(TF_INIT_BACKEND_OPTS),$(TF_BACKEND_CONFIG)) $(TF_INIT_FLAGS)
	AWS_PROFILE=$(AWS_PROFILE) AWS_REGION=$(AWS_REGION) AWS_DEFAULT_REGION=$(AWS_DEFAULT_REGION) $(TF) -chdir=$(TF_DIR) plan -input=false $(TF_PLAN_ARGS)
