...
- [x] La migration s’applique en local via une commande documentée et crée les deux tables avec la FK.
- [x] Les tests d’intégration DB passent toujours après migration.
- [x] docs/DEV.md explique comment lancer les migrations (dev et CI) et le comportement par défaut du restaurant lié.
